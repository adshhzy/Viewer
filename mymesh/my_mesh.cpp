...
void Mesh::ReScale_uniform(double lscale,bool isMoveCent){
    setparameters();
    double xmin = 9e9, ymin=9e9,zmin=9e9,xmax=-9e9,ymax=-9e9,zmax=-9e9;
...
bool Mesh::readObjfile(string filename){
    ...
    vector<double>vn;
    readObjFile(filename,vertices,faces2vertices,vn);
