...
public:
    ...
    void ComputeMat2VerticesLoop(vector<vector<int>>&verticesloops, vector<vector<int>>&edgesloops, vector<vector<double>>&verticesSeqs, vector<int>&loops2mats);

    int getnumberofloops();
    void WriteContourToFCM(ofstream &out);
    void WriteContourToFCMtCtr(ofstream &out);

    void EdgeMidPointToNormal(double eps, vector<double> &re_points, vector<int> &labels);
    void GetEdgesNormal(vector<double>&enormal, bool isstackup = false);


    void Set_EdgeNormal(vector<double>&enormal);
    bool ReadContour_Contourpp(ifstream &in);
    bool WriteContour_Contourpp(ofstream &out);
...
public:
    ...
    void Stackup(vector<double>&points, vector<uint> &edges, vector<double>&enormal);
    void MapMaterials();
    int WriteCrossSections(string filename);
    int WriteCrossSections_Contourpp(string filename);
    ...
    bool ReadCrossSections_Contourpp(string filename);
    bool ReadCrossSections_Ctr(string filename);
    ...
    void GetProperty(vector<double>&mid,vector<double>&leftc,vector<double>&rightc);


    void Set_EdgeNormal(vector<uint>&eind, vector<double>&vnormal);
    void StackUp_EdgeMapper(vector<int>&e2C, vector<int>&e2Ce);
public:
