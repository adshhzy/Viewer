...
public:
    ...
    void GetScaleInfo(double &lscale, double *pcenter);
    ...
    vector<bool>InterpretVisibility(bool isCS, bool isAllMat, bool isNonC, int pickMat);
...
public:
    ...
    vector<bool>InterpretVisibility(bool isCS, bool isAllSurf, bool isNonC, int pickCell);
